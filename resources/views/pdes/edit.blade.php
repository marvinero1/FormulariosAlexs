                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="nombre">Meta</label>
                                            <select class="form-control" name="meta" required>
                                                <option value="Impulsar nuevas industrias de productos estratégicos orientadas a la sustitución de importaciones que permitan reducir nuestra dependencia de la produccion externa.">Impulsar nuevas industrias de productos estratégicos orientadas a la sustitución de importaciones que permitan reducir nuestra dependencia de la produccion externa.</option>
                                                <option value="Incrementar volúmenes de producción de bienes de consumo importados y de insumos, bienes y servicios sustitutos de importación.">Incrementar volúmenes de producción de bienes de consumo importados y de insumos, bienes y servicios sustitutos de importación.</option>
                                                <option value="Promover politicas de transformación de materias primas e insumos para generar cadenas productivas de valor que permitan aumentar los valúmenes de producción naciional.">Promover politicas de transformación de materias primas e insumos para generar cadenas productivas de valor que permitan aumentar los valúmenes de producción naciional.</option>
                                            </select>
                                        </div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="meta" required>
                                                ...
                                                <option value="Fortalecer, viversificar y ampliar la industrialización con valor agregado de recursos naturales, maximizando los excedentes aconómicos generados.">Fortalecer, viversificar y ampliar la industrialización con valor agregado de recursos naturales, maximizando los excedentes aconómicos generados.</option>
